...
def main():
    ...
    with open('data/size.txt', 'w') as f:
        sys.stdout = f
        print(w)
    ...
    for _ in range(args.n):
        ...
        color_grid, mapping = draw.color_tubes(
            grid, no_colors=args.no_colors)

        # Print stuff
        debug(grid)

        # print(w, h)
        with open('data/board_raw.txt', 'w') as f:
            sys.stdout = f
            if args.zero:
        ...
        with open('data/solution_raw.txt', 'w') as f:
            sys.stdout = f
            if args.solve:
                # print('Solution:')
